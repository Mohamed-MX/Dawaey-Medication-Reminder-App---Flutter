...
class MedicianCard extends StatelessWidget {
  ...
  String get name => data.medication.medicationName;

  String get dose => data.medication.dosage;

  TimeOfDay get time => data.dose.time;

  DoseStatus get status => data.dose.status;
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: (){
          Navigator.pushNamed(context, '/medication_details' , arguments: data.medication);
        },
        child: Container(
